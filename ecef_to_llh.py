...
# Other contributors: Matthew Moore
#
# This work is licensed under CC BY-SA 4.0
#
# This question on assigment 3 is kind of unclear to me,
# as this script that is provided follows the same algorithm
# to solve ECEF to LLH transformations as the slides show.
# This means there isn't anything for me to add, and if I
# write the script from scratch it will be borderline
# identical.
#
# So if just submitting this isn't what was asked,
# I will take the 0 for the question but would appreciate
# an explanation as to what else should've been done for this
# if possible.
...
print("Longitude: " + str(lon_deg))
print("Latitude: " + str(lat_rad*180.0/math.pi))
print("Height Above Ellipsoid: " + str(hae_km))
